...
def listar_totais_por_categoria(cur, usuario_id, filtros, contas_visiveis_ids=None, cartoes_visiveis_ids=None):
    """
...
def somar_total_geral(cur, usuario_id, filtros, contas_visiveis_ids=None, cartoes_visiveis_ids=None):
    """
    Soma o total geral (receitas + despesas) dos lançamentos filtrados,
    usado para exibir o saldo do período no topo do relatório.
    Mesma lógica de filtros e permissão da função acima, sem agrupamento.
    """
    sql = """
