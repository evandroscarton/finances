...
def pagar_fatura_cartao(usuario_id, cartao_id, conta_pagamento_id, valor, data_pagamento,
    ...
    2. Marca como 'compensado' (com data_compensacao = data_pagamento) APENAS
       ...
       mantém o comportamento anterior de compensar todos os pendentes.
    ...
    with get_cursor(commit=True) as cur:
        ...
        # 2. Marca como compensados apenas os lançamentos dentro do
        # intervalo de data_compensacao filtrado na tela de Fatura.
        # Construção dinâmica com %s — nunca concatenação de valor de usuário.
        sql = """
            UPDATE lancamentos
